  ...
  return (
    ...
    transition={{ duration: 0.4}}  className='absolute w-screen h-screen bg-backdark text-3xl md:hidden  text-gray-700  z-10  justify-center py-20 -mt-8 '>
            ...
            <motion.ul initial={{scale: 0.5, opacity:0.5}} animate={{ opacity: 1, scale: 1 }} exit={{opacity: 0, scale: 0.5}}className='flex flex-col gap-20 w-21 justify-center px-20' >
                ...
                <motion.li
                 initial={{ scale: 0, x:400}} animate={{scale: 1, x:0}} transition={{duration: 0.2}} exit={{  x:-100}}
                ...
                <motion.li 
                initial={{ scale: 0,x:300}} animate={{scale: 1, x:0}} transition={{duration: 0.4}} exit={{  x:100}}
                ...
                <motion.li 
                 initial={{ scale: 0, x:400}} animate={{scale: 1, x: 0}} transition={{duration: 0.5}} exit={{  x:100}}
                whileHover={{ scale: 1.2, transition: {duration: 0.2} }} whileTap={{ scale: 1.1 }}>
                    <a href='#projects' className='hover:text-gray-200 flex gap-1'><p className='text-purple-500 font-bold'>#</p>
                        Projects</a>
                </motion.li>
                <motion.li
                 initial={{ scale: 0, x:400}} animate={{scale: 1, x:0}} transition={{duration: 0.7}} exit={{  x:100}}
                whileHover={{ scale: 1.2, transition: {duration: 0.2} }} whileTap={{ scale: 1.1 }}>
            ...
            <a target='_blank' href='https://linkedin.com/in/marvel-ogoke'><Image className='w-12' src={LinkedIn} alt='linkedIn Link' height={400} width={400}/></a>
            <a target='_blank' href='https://github.com/ceejaycodes'><Image className='w-12' src={Github} alt='Github Link'  height={400} width={400}/></a>
            <a target='_blank' href='mailto:dreelceejay79@yahoo.com'><Image className='w-12' src={Email} alt='Email Link'  height={400} width={400}/></a>
        </div>
        </motion.div>
        </AnimatePresence>
        }
