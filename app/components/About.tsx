...
My approach to software engineering is grounded in the philosophy that technology should serve as an enabler,
 simplifying lives and fostering meaningful connections. This ethos extends beyond the screen, guiding my creative pursuits in music and poetry.

<br></br>As you navigate through this digital space, I invite you to explore the intersections of my professional endeavors and personal passions. Together, let's embark on a journey where technology meets artistry,
 and where every line of code is infused with both precision and poetry. Welcome to the harmonious convergence of logic and creativity.
                ...
                <a className='pointer ' onClick={handleAbout}>View Less</a></motion.div>}
        </AnimatePresence>
            ...
            <div className=' my-18 py-10'>
                    ...
                    <motion.div  initial={{opacity: 0}} animate={{opacity: 1}} transition={{duration: 3, repeat: Infinity, repeatType: "reverse", repeatDelay: 1}} >
