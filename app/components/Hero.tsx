...
const Hero = (props: Props) => {
  ...
  return (
    ...
    />
        ...
        <div>
        <a target='_blank' href='https://www.dropbox.com/scl/fi/3zytxojhp0kaafer1ikdg/Resume-Marvel-Ogoke-july-2023.pdf?rlkey=44yg73t78o5kgnhp1artj8gz3&dl=0'> 
          <motion.button initial={{opacity: 0.1, scale: 0}} animate={{opacity: 1, scale: 1}} transition={{duration:1}} whileHover={{opacity: 0.8, scale: 1.1, transition:{duration: 0.2}}} className='flex rounded-lg bg-white p-2 border-purple-500 '>
